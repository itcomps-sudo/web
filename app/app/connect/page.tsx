    ...
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mt-12 space-y-5">
        <div className="flex items-start gap-5 rounded-xl2 border border-mist bg-white p-6">
          ...
          <div>
            <h2 className="text-xl font-semibold text-ink">Download the connection tool</h2>
            <p className="mt-1 text-lg text-ink/70">
              It&apos;s called RustDesk, and it&apos;s free. Click the button below and open the
        ...
        <div className="flex items-start gap-5 rounded-xl2 border border-mist bg-white p-6">
          ...
          <div>
            <h2 className="text-xl font-semibold text-ink">Open it and find your code</h2>
            <p className="mt-1 text-lg text-ink/70">
              Once it opens, you&apos;ll see an ID number and password on the screen. That code
              is what lets us connect — nothing happens until you share it with us.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-5 rounded-xl2 border border-mist bg-white p-6">
          ...
          <div>
            ...
            <p className="mt-1 text-lg text-ink/70">
              Call {businessConfig.phone} and tell us the ID and password you see. We&apos;ll
              use it to connect right away.
            </p>
            <a
