...
export default function HomeComputerCarePage() {
  return (
    <div className="mx-auto max-w-6xl px-6 py-16">
      ...
      <div className="mt-16 grid gap-8 rounded-xl2 border border-mist bg-white/60 p-8 md:grid-cols-2">
        <div>
          <h2 className="font-display text-2xl font-semibold text-ink">Why choose {businessConfig.name}?</h2>
        ...
        <div className="flex flex-col justify-center">
          ...
          <Link
            ...
            className="mt-4 inline-block text-lg font-semibold text-amber-dark underline underline-offset-4"
          >
